...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.label = None
        # menu frame
        self.menu_frame = CTkFrame(self, width=30, height=300, fg_color="red")
        self.menu_frame.pack_propagate(False)
        self.menu_frame.place(x=0, y=0)
        self.is_show_menu = False
        self.speed_animate_menu = -5
        self.btn = CTkButton(self, text="▶️", command=self.toggle_show_menu, width=30, fg_color="blue")
        ...
        self.send_button = CTkButton(self, text=">", width=50, height=40, command=self.send_message, fg_color="red")  # add send comm⬅️
    ...
    def save_name(self):
        ...
        if new_name:
            ...
            self.add_massage(f"[SYSTEM] Ім'я змінено на: {new_name}")
win = MainWindow()
win.mainloop()